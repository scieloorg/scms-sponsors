...
class IdentifiedSponsorsHelper(ButtonHelper):
    ...
    def validate_button(self, obj):
        ...
        text = _("Validate")
        return {
            "url": reverse("identified_sponsors:validate") + "?file_id=%s" % str(obj.id),
            "label": text,
    ...
    def import_button(self, obj):
        ...
        text = _("Import")
        return {
            "url": reverse("identified_sponsors:import_file") + "?file_id=%s" % str(obj.id),
            "label": text,
