...
class OfficialSponsorNamesHelper(ButtonHelper):
    ...
    def validate_button(self, obj):
        ...
        text = _("Validate")
        return {
            "url": reverse("official_sponsors:validate") + "?file_id=%s" % str(obj.id),
            "label": text,
    ...
    def import_button(self, obj):
        ...
        text = _("Import")
        return {
            "url": reverse("official_sponsors:import_file") + "?file_id=%s" % str(obj.id),
            "label": text,
